...
public class DynamicGrid {
    ...
    public DynamicGrid(Context context, Resources resources,
        ...
        deviceProfiles.add(new DeviceProfile("Super Short Stubby",
                255, 300,  2, 3,  48, 13, (hasAA ? 3 : 4), 48, R.xml.default_workspace_4x4,
                R.xml.default_workspace_4x4_no_all_apps));
        deviceProfiles.add(new DeviceProfile("Shorter Stubby",
                255, 400,  3, 3,  48, 13, (hasAA ? 3 : 4), 48, R.xml.default_workspace_4x4,
                R.xml.default_workspace_4x4_no_all_apps));
        deviceProfiles.add(new DeviceProfile("Short Stubby",
                275, 420,  3, 4,  48, 13, (hasAA ? 4 : 4), 48, R.xml.default_workspace_4x4,
                R.xml.default_workspace_4x4_no_all_apps));
        deviceProfiles.add(new DeviceProfile("Stubby",
                255, 450,  3, 4,  48, 13, (hasAA ? 4 : 4), 48, R.xml.default_workspace_4x4,
                R.xml.default_workspace_4x4_no_all_apps));
        deviceProfiles.add(new DeviceProfile("Nexus S",
                296, 491.33f,  4, 4,  48, 13, (hasAA ? 4 : 4), 48, R.xml.default_workspace_4x4,
                R.xml.default_workspace_4x4_no_all_apps));
        /// M: add 294 X 460 profile
        deviceProfiles.add(new DeviceProfile("294 X 460",
                294, 460,  4, 4,  50.34943f, 13, (hasAA ? 4 : 4), 49.566288f, R.xml.default_workspace_4x4,
                R.xml.default_workspace_4x4_no_all_apps));
        deviceProfiles.add(new DeviceProfile("Nexus 4",
                335, 567,  4, 4,  DEFAULT_ICON_SIZE_DP, 13, (hasAA ? 4 : 4), 56, R.xml.default_workspace_4x4,
                R.xml.default_workspace_4x4_no_all_apps));
        deviceProfiles.add(new DeviceProfile("Nexus 5",
                359, 567,  4, 4,  DEFAULT_ICON_SIZE_DP, 13, (hasAA ?4 : 4), 56, R.xml.default_workspace_4x4,
                R.xml.default_workspace_4x4_no_all_apps));
